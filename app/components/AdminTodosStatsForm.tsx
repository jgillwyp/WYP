...
// ToDos Activity screen (Statistics section) — see
      ...
      <div className="app">
        ...
        <div className="scroll">
          <div className="subempty">
            ToDos Activity is being built next — Created, Changed, Done, Deleted,
            Archived, Unarchived, Attachments, and Dialog, per week or month.
          </div>
        </div>
      </div>
    </div>
